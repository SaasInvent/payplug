var config, exports, forge, fs, ipn, querystring, uuid;
...
module.exports = exports = {
  ...
  getPayplugPublicKey: function() {
    return fs.readFileSync("payplugPublicKey", "utf8");
  },
  getYourPrivateKey: function() {
    return fs.readFileSync("yourPrivateKey", "utf8");
  },
  getIpnUrl: function() {
    return ipn.ipn_url;
  },
  ...
  verifySignature: function(data) {
    return console.log("verifySignature");
  }
};
